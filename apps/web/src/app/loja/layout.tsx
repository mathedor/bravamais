...
const DESKTOP_NAV = [
  ...
  { href: "/loja/hoje", label: "Hoje" },
  { href: "/loja/cupons", label: "Cupons" },
  { href: "/loja/vale-presente", label: "Vale-presente" },
  { href: "/loja/fidelidade", label: "Fidelidade" },
];
      ...
      <DashboardHeader
        ...
        rightSlot={
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/loja/perfil"
              className="hidden rounded-full border border-brava-border bg-white px-3 py-1.5 text-xs font-bold text-brava-ink sm:inline-flex"
            >
              Editar perfil
            </Link>
            <SignOutButton className="rounded-full border border-brava-border bg-white px-3 py-1.5 text-xs text-brava-ink hover:bg-brava-paper" />
          </div>
        }
      />
